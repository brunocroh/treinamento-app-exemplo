...
public class WebAppInitializer implements WebApplicationInitializer {
	 ...
	 * @param servletContext - the parent servlet context.
	...
	private WebApplicationContext registerContextLoaderListener(ServletContext servletContext) {
		...
		dispatcherContext.register(App.class);
	...
	private void registerSpringWebMvcServlet(ServletContext servletContext, WebApplicationContext rootContext) {
		javax.servlet.ServletRegistration.Dynamic dispatcher = servletContext.addServlet(DISPATCHER_SERVLET_NAME, new DispatcherServlet(rootContext));
